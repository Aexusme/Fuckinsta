...
\_   _____/_ __   ____ |  | _|   | ____   _______/  |______   
 |    __)|  |  \_/ ___\|  |/ /   |/    \ /  ___/\   __\__  \  
 |     \ |  |  /\  \___|    <|   |   |  \\___ \  |  |  / __ \_
 \___  / |____/  \___  >__|_ \___|___|  /____  > |__| (____  /
     \/              \/     \/        \/     \/            \/  
                                                            
                   Version 1.0 - Developed by Aexusme{res}
"""

help = f"""
    {red}Usage {ylw}: {grn}python Fuckinsta.py [OPTION] ...
    ...
    {ylw}Use help 
        ...
        {red}[{blu}SetSession{red}] {grn}python {red}Fuckinsta.py {ylw}--set{red}/{ylw}-s {red}[{grn}Instagram SessionID{red}]
        {red}[{blu}Run{red}] {grn}python {red}Fuckinsta.py {ylw}--run{red}/{ylw}-r {red}[{grn}Target UserName{red}]
"""
